      ...
      <div className="w-full lg:w-2/5 bg-white rounded-lg shadow-lg p-4 md:p-6 md:mt-16 md:pr-14">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start bg-blue-50 p-3 md:p-4 rounded-3xl shadow mb-4 md:mb-6">
          ...
          <div className="sm:ml-4 text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-semibold text-blue-900">Gunjan Sharma</h3>
            <p className="text-sm md:text-base text-blue-800">Owner : Hindu Pharma</p>
            <p className="text-sm md:text-base text-blue-600 break-all sm:break-normal">Email: akash2244@gmail.com</p>
            <p className="text-sm md:text-base text-blue-600">Phone: +91 9876543210</p>
          </div>
        </div>
